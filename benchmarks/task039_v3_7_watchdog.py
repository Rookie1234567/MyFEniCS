...
V10_H4_SUPERNODE_FACTOR_INTEGRITY_PROFILE = (
    ...
    *,
    ...
    if v5_h4_setup_only:
        ...
        if (
            ...
            raise ValueError(
                "V10 full producer requires packet, exact spool, and output roots"
            )
        argv.extend(
            [
                V10_H4_SIDE_RESPONSE_PACKET_FULL_PRODUCER_FLAG,
        ...
        argv.extend(
            [
                ...
                V10_H4_SUPERNODE_FACTOR_INTEGRITY_EXACT_SPOOL_ROOT_FLAG,
                str(Path(v10_h4_supernode_factor_integrity_exact_spool_root).resolve()),
            ]
        )
    elif v10_h4_sn2_j_only:
    ...
    return {
        ...
        "worker_contract": {
            ...
            "response_packet_output_root": (
                ...
                if v10_h4_side_response_packet_full_producer_output_root is not None
                else None
            ),
            "response_packet_manifest": (
                str(Path(v10_h4_side_response_packet_compression_manifest).resolve())
                if v10_h4_side_response_packet_compression_manifest is not None
                else None
            ),
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        V10_H4_SUPERNODE_FACTOR_INTEGRITY_FLAG,
        dest="v10_h4_supernode_factor_integrity",
        action="store_true",
    )
    parser.add_argument(
        V10_H4_SUPERNODE_FACTOR_INTEGRITY_EXACT_SPOOL_ROOT_FLAG,
        dest="v10_h4_supernode_factor_integrity_exact_spool_root",
    )
