...
| [`080`](080_hybrid_fem_modal_direct_baseline/README.md) | Task32 Hybrid FEM-modal direct baseline | Phase 1/2/3/4 recorded；coupling/Hybrid pending | clean h5/h3 full-3D reference；clean QEP；clean Poynting/adjoint-QEP/biorthogonal/tracking；clean 100 nm two-port propagation |
