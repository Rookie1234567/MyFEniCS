...
| [`080`](080_hybrid_fem_modal_direct_baseline/README.md) | Task32 Hybrid FEM-modal direct baseline | Phase 1/2 recorded；Phase 3 research passed | clean h5/h3 full-3D reference；clean QEP；research Poynting/adjoint-QEP/biorthogonal/tracking；Hybrid pending |
