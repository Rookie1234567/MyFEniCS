...
| [`091`](091_hybrid_hp_adaptivity_feasibility/README.md) | Task33 high-order/Hybrid h-p feasibility | stage1 complete；original adaptivity scope deferred | tracked stage summary + Task032 p2 Hybrid/full3D 对比；完整 21-role formal closure 未完成 |
