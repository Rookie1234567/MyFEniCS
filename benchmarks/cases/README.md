...
| [`080`](080_hybrid_fem_modal_direct_baseline/README.md) | Task32 Hybrid FEM-modal direct baseline | Phase 1/2 recorded / Hybrid pending | clean h5/h3 full-3D reference；clean MPI4 匹配截面 QEP、解析/有损 beta、±配对和 MPI ownership |
