...
| [`090`](090_neural_local_pc_acceleration/README.md) | PARA-Task001 neural local PC | h5_numeric_pass_engineering_negative | one-slab 数值通过、迭代 -0.813%，但总时间 2.888×，停止 h3/h2 |
