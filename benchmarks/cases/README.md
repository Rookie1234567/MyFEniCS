...
| [`080`](080_hybrid_fem_modal_direct_baseline/README.md) | Task32 Hybrid FEM-modal direct baseline | Phase 1 recorded / Phase 2 implementation passed | clean h5/h3 full-3D reference；匹配截面 QEP、解析/有损 beta、±配对和 MPI ownership |
