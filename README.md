...
普通运行的完整网格、场和日志写入 `results/`，不提交 Git。轻量 benchmark 摘要放在 `benchmarks/records/`。

## 文档导航

| 文档 | 内容 |
|---|---|
| [快速开始](docs/quick_start.md) | 环境、普通入口、workstation 入口 |
| [架构概览](docs/architecture_overview.md) | 模块边界与数据流 |
| [求解器指南](docs/solver_guide.md) | direct/iterative 选择与限制 |
| [能力矩阵](docs/capability_matrix.md) | 已支持与未支持能力 |
| [结果 schema](docs/result_schema.md) | JSON、RSS、R/T/A 字段 |
| [Benchmark](docs/benchmark.md) | 分层验证与当前记录 |
| [任务索引](docs/README.md) | Task000-Task028 闭环 |
