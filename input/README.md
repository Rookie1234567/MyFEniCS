...
| `solver.h6_backend_rule` | `enum` | `none` | no | `—` | native_ffcx_power10_then_packed_apply, isotropic_sum_factorized_n1e_v26_apply_and_power10 | full3d_iterative | H6 apply and power-estimation backend rule | `H6 backend rule` | explicit V25 backend contract | `"native_ffcx_power10_then_packed_apply"` |
| `solver.thread_contract` | `enum` | `none` | no | `—` | profile_default, mpi1_omp1_blas1_v25 | full3d_iterative | explicit execution-thread contract | `thread contract` | V25 selected profile fixes MPI1/OMP1/BLAS1 | `"profile_default"` |
