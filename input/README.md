...
| `solver.stage` | `enum` | `none` | no | `STANDARD` | STANDARD, N1_CALIBRATION, N2_M1_CONTROLS, N3_RESTART_PROBE, N4_ORIGINAL, N4_NOTCH, U0_PREFLIGHT, U1_CONTROL_BRIDGE, U2_EXACT_CONTROL, U3_BLR_CONTROL, U4_ORIGINAL, U4_EXACT_FALLBACK, U5_NOTCH, U6_FINALIZE | full3d_iterative | V11/N3/N4/V18 execution stage identity | `stage` | stage is an input identity; its budgets remain in the selected profile ledger | `"STANDARD"` |
