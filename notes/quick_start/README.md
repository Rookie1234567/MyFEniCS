...
| Task33 高阶 Floquet / Hybrid h-p / 自适应 | [`60_task033_high_order_hybrid_hp.md`](60_task033_high_order_hybrid_hp.md) | 无 main preset | p3/p4 高阶阶段已完成；自适应范围延期；完整 formal closure 未完成 |
