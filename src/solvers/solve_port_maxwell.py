...
from ..postprocessing.power_metrics import compute_dtn_port_power_metrics, compute_power_metrics
...
def run_port_case(
    ...
    if constraint_backend in ("mpc_official", "mpc_lowlevel"):
        ...
        if cfg.port_boundary_model == "dtn":
            A_csr, b_np, port_modes, port_trace_vectors = _add_fourier_port_operators(
