    ...
    audit.update(
        {
            ...
            # failure. Keep call completion separate from pages released.
            "succeeded": True,
            "call_completed": True,
...
def _write_progress_event(
    ...
    *,
    ...
    try:
        ...
        current_by_rank = _gather_optional_rank_floats(comm, local_current_rss)
        peak_by_rank = _gather_optional_rank_floats(comm, local_peak_rss)
