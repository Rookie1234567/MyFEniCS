...
FIELD_SPECS: Final = (
    ...
    _f(
        ...
        "cells",
        ("full3d_iterative",),
        "R13 V5 冻结张量网格的 x/y/z 单元数",
        "mesh_axis_cell_counts",
        "[9, 5, 22]",
        constraints=("R13 V5 only; must match the frozen mesh plan",),
    ),
    _f(
        ...
        "nm",
        ("full3d_iterative",),
        "R13 V5 冻结 mesh 的显式 x 轴坐标",
        "mesh_axis_x_values",
        "[0.0, ... , 50.0]",
        constraints=("R13 V5 only; exact frozen-plan values",),
    ),
    _f(
    ...
    _f(
        ...
        "mesh_plan_sha256",
        '"b5bab6..."',
        constraints=("R13 V5 only; exact frozen-plan hash",),
    ),
    _f(
    ...
    _f(
        ...
        '"default"',
        required=True,
        allowed=("default", "mumps_ooc", "mumps_blr", "native_matched_reference"),
    ),
    _f(
        "solver.reference_witness_path",
        "path",
        "filesystem path",
        ("full3d_direct",),
        "hash-bound native matched-reference witness audit",
        "native matched-reference witness audit path",
        '"docs/task39extra_para_workstation_capacity/outcomes/records/r1_attempt3_reference_witness.json"',
        constraints=("required only for direct_solver_profile=native_matched_reference",),
    ),
    _f(
        ...
        "sha256",
        ("full3d_direct",),
        "hash of the native matched-reference witness audit",
        "native matched-reference witness audit SHA256",
    ...
    _f(
        ...
        "none",
        ("full3d_iterative",),
        "execution deadline policy; explicit none is an opt-in without a wall/solve deadline",
        "execution.time_limit_mode",
        '"bounded"',
        default="bounded",
        allowed=("bounded", "none"),
        constraints=("none is an explicit opt-in; resource and iteration gates remain active",),
    ),
    _f(
    ...
    _f(
        ...
        "7200",
        required=False,
        constraints=("> 0 when time_limit_mode=bounded; omitted when time_limit_mode=none",),
    ),
    _f(
