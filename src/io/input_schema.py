...
FIELD_SPECS: Final = (
    ...
    _f(
        ...
        "none",
        ("full3d_iterative",),
        "显式几何模型分支标识；不由 stage 名称推断",
        "geometry_model_variant",
        '"original"',
        allowed=("original", "frozen_notch"),
    ),
    _f(
    ...
    _f(
        ...
        "mesh_plan_sha256",
        '"b5bab6..."',
        constraints=("64 lowercase hexadecimal characters",),
    ),
    _f(
        ...
        "[9, 5, 22]",
        constraints=("exactly three positive integers",),
    ),
    _f(
    ...
    _f(
        ...
        "显式 x 轴坐标；与冻结计划逐项绑定",
        "mesh_axis_x_values",
        "[0.0, 5.5, 11.0, 16.5, 22.166666666666668, 27.833333333333336, 33.5, 39.0, 44.5, 50.0]",
        constraints=("strictly increasing; endpoints equal x bounds",),
    ),
    _f(
        ...
        "显式 y 轴坐标；与冻结计划逐项绑定",
        "mesh_axis_y_values",
        "[0.0, 4.166666666666667, 8.333333333333334, 13.88888888888889, 19.444444444444443, 25.0]",
        constraints=("strictly increasing; endpoints equal y bounds",),
    ),
    _f(
        ...
        "显式 z 轴坐标；与冻结计划逐项绑定",
        "mesh_axis_z_values",
        "[-10.0, -5.0, 0.0, 6.666666666666667, 13.333333333333334, 20.0, 26.666666666666668, 33.333333333333336, 40.0, 46.666666666666664, 53.333333333333336, 60.0, 66.66666666666667, 73.33333333333334, 80.0, 86.66666666666667, 93.33333333333333, 100.0, 106.66666666666667, 113.33333333333334, 120.0, 125.0, 130.0]",
        constraints=("strictly increasing; endpoints equal z bounds",),
    ),
    _f(
    ...
    _f(
        ...
        default="LEGACY_LOCAL_MUMPS_MEMORY_POLICY",
        allowed=(
            "LEGACY_LOCAL_MUMPS_MEMORY_POLICY",
    ...
    _f(
        ...
        "none",
        ("full3d_iterative",),
        "V11/N3/N4 execution stage identity",
        "stage",
        '"STANDARD"',
        default="STANDARD",
        allowed=(
        ...
        constraints=("stage is an input identity; its budgets remain in the selected profile ledger",),
    ),
    _f(
        ...
        "iterations",
        ("full3d_iterative",),
        "N3/N4 outer FGMRES restart; zero means not active for a macro control stage",
        "outer_restart",
        "0",
        default="0",
        allowed=("0", "32", "64"),
        constraints=("only 0, 32, or 64; macro I4 restart remains solver.restart=4",),
    ),
    _f(
        ...
        "polynomial degree",
        ("full3d_iterative",),
        "V25 direct physical coarse degree; omitted by older profiles",
        "coarse_degree",
        "4",
        allowed=("2", "3", "4"),
        constraints=(
            "V25 only; the selected Q2/Q3/Q4 stage fixes the actual value",
        ),
    ),
    _f(
        ...
        "none",
        ("full3d_iterative",),
        "V25 physical volume-action backend identity; older profiles keep their native default",
        "physical operator backend",
        '"native_profile_default"',
        allowed=("native_profile_default", "isotropic_sum_factorized_n1e_v26"),
    ),
    _f(
        ...
        "none",
        ("full3d_iterative",),
        "H6 apply and power-estimation backend rule",
        "H6 backend rule",
