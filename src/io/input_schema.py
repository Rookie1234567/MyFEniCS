...
FIELD_SPECS: Final = (
    ...
    _f(
        ...
        "90",
        required=True,
        constraints=("only hybrid_iterative; > 0",),
    ),
    _f(
    ...
    _f(
        ...
        "integer",
        "bytes",
        ("full3d_direct", "hybrid_direct", "hybrid_iterative"),
        "显式绝对进程树内存终止上限；存在时 terminate_memory_gib 仅为 critical checkpoint，缺失时沿用 GiB 旧策略；Task39仅接受批准的h5 profile",
