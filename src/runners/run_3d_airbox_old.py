...
from ..solvers.solve_maxwell_3d_stage_2_no_grating_old import STAGE2_CASES, run_stage2_no_grating_3d_case
from ..solvers.solve_maxwell_3d_stage_4_grating_old import STAGE4_CASES, run_stage4_grating_3d_case
...
def main(argv: list[str] | None = None):
    ...
    parser.add_argument("--validation-role", default=None, help="Validation role for reports.")
