...
class TestTask037bHybridBlockOperator:
    ...
    def test_inventory_mapping_and_pack_split(self):
        ...
        assert self.context.inventory == {
            ...
            "bottom_global_F_materialized": True,
            "top_global_F_materialized": True,
            "bottom_explicit_external_c_matrix_count": 1,
            "bottom_explicit_external_d_matrix_count": 1,
            "top_explicit_external_c_matrix_count": 1,
            "top_explicit_external_d_matrix_count": 1,
            "bottom_direct_factor_count": None,
            "top_direct_factor_count": None,
            "explicit_external_c_matrix_count": 2,
            "explicit_external_d_matrix_count": 2,
            "p6_direct_factor_count": None,
