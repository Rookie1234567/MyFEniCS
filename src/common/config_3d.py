...
class SimulationConfig3D:
    ...
    # Task036 opt-in independent projection audit.  Official port amplitudes
    # remain the auxiliary unknowns; this only reprojects the recovered
    # tangential field and reports their discrepancy.
