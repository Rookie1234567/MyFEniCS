...
git checkout master
git pull
git merge codex/20260702-rta-output-volume-absorption
...
```text
h = 8, 6, 5, 4, 3, 2.5, 2, 1.5, 1.0, 0.5 nm
```
...
9. 迭代法相比直接法可能节省多少内存？
10. 为了跑  h=2.5 / h=2 / h=1.5 / h=1.0 / h=0.5，大概需要多大 RAM 和 SSD？
11. 推荐购买 128 GB、256 GB、512 GB 还是 1 TB 内存的工作站，硬盘应该配多大的存储空间？
...
4. 给出迭代法内存估算表。
5. 给出 h=2.5 / h=2 / h=1.5 / h=1.0 / h=0.5 的工作站资源建议。
