...
| Task032 | Hybrid FEM–Modal direct baseline | Phase 0/1/2 complete；Phase 3 implementation/research passed，clean record pending |
...
| Task032 | `task032_hybrid_fem_modal_direct_baseline/` | Phase 1 reference、Phase 2 clean QEP 完成；Phase 3 Poynting/adjoint-QEP/biorthogonal/tracking research passed；clean record/coupling/Hybrid pending |
