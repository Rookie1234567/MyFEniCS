...
Phase 2 已在 clean source `33211a4ac6d4f6717351197a93c506e1adec609f` 后完成正式记录与自动 Gate。Phase 3 也已完成 Poynting 方向分类、物理衰减分支、left/right 双正交归一化和近简并子空间处理；Phase 4 稳定双向传播当前已进入 clean record 前的实现收口。
