...
完整 compact record 见 `../../../benchmarks/cases/101_hybrid_iterative_block_solver/records/task037b_v4_mpi8_full_qualification_v1.json`。该历史材料只保留在远程 Task37b 执行分支，不进入 master。
...
`../../../benchmarks/cases/101_hybrid_iterative_block_solver/records/task037b_v5_mpi8_multimetric_full_qualification_v1.json`。
