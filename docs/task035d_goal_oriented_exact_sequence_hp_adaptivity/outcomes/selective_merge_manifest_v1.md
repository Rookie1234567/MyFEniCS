...
| `checker_benchmark` | 42 | `include` |
| `compact_evidence_docs` | 43 | `include` |
| `research_only` | 47 | `exclude_keep_source_branch` |
...
| `src/test/test_193_task035d_case097_runner_gates.py` | `A` | `research_only` | `exclude_keep_source_branch` | `candidate_specific_research_history` | historical branch receipts | not applicable |
| `src/test/test_194_task035d_case097_checker.py` | `A` | `research_only` | `exclude_keep_source_branch` | `candidate_specific_research_history` | historical branch receipts | not applicable |
...
| `src/test/test_209_task035d_nested_p_runner.py` | `A` | `research_only` | `exclude_keep_source_branch` | `candidate_specific_research_history` | Task035d historical branch receipts | not applicable |
