...
| T4 `full3d_direct` Full3D / MPI1 | `5.520787756471226e-14` | R=`0.9997827084780738`；T=`0.00010870177442776488`；A_volume=`0.00010858974749584228`；closure≈`-2.55e-15` | 4.231s | 236.641 MiB / 0 MiB | §14.2 pass |
