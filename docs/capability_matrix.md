...
| Task035b assembly-time high-p condensation | experimental | Case095，MPI8 explicit opt-in | hexa p4/p5/p6 cell-interior Schur、Floquet slave physical elimination、tensor dedup、exact preallocation 与 factor lifecycle 有实测正结果；ordinary default 不变 |
...
| condensed trace factor-free iterative screen | not_implemented | Case095 capability audit | 未来 MPI8 GMRES screen 合同已冻结；当前 dedicated hook、residual history 与 factor-free inventory 缺失，不能把 direct record 或 24-byte/NNZ proxy 冒充迭代实测 |
