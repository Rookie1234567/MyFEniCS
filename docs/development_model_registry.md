...
>
> **2026-07-26 历史回填。** 本版重新核对 Task000–Task035c 的 outcomes、response、review 和 compact records。方法级成功表已补齐 Task034 的 p2/p3/p4 Full3D、Hybrid、M funnel 与 MPI identity；逐 Task 第3章继续保留失败、停止和未运行证据。
