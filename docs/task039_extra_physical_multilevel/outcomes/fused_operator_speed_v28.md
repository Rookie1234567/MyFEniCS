...
这些数字来自受控保存向量的组件配对，不包含完整 p4 因子、FGMRES 历史、正式场恢复和物理后处理，不能与 r2 full/KSP 时间相除后宣称 speedup。
...
- formal raw root：`results/euv_grazing1_phi0/task39extra_v28_fused_kernel_original_h7p5__full3d_iterative__mpi1__Mna/20260923T144543.633563Z/`。
